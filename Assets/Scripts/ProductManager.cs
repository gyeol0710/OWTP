...
public class ProductManager : MonoBehaviour
{
    ...
    IEnumerator AutoMoneyGo()
    {
        while(true)
        {
            autoMoney = (long)((((perOneAutoMoney1 * Prod_1_Level) + (perOneAutoMoney3 * Prod_3_Level) + (perOneAutoMoney4 * Prod_4_Level) +  + (perOneAutoMoney7 * Prod_7_Level) + (perOneAutoMoney8 * Prod_8_Level) +
                    ...
                    (perOneAutoMoney33 * Prod_33_Level) + (perOneAutoMoney35 * Prod_35_Level) + (perOneAutoMoney36 * Prod_36_Level) + (perOneAutoMoney37 * Prod_37_Level)) * (GameManager.Engine2Bonus)) + (perOneAutoMoney38 * Prod_38_Level) + (perOneAutoMoney39 * Prod_39_Level) +
    ...
    IEnumerator AutoScienceGo()
    {
        while(true)
        {
            autoScience = (long)((((perOneAutoScience5 * Prod_5_Level) + (perOneAutoScience6 * Prod_6_Level) + (perOneAutoScience9 * Prod_9_Level) + (perOneAutoScience13 * Prod_13_Level) + (perOneAutoScience15 * Prod_15_Level) +
                        (perOneAutoScience18 * Prod_18_Level) + (perOneAutoScience22 * Prod_22_Level)) * (GameManager.Fuel2Bonus * GameManager.Engine2Bonus)) + (((perOneAutoScience24 * Prod_24_Level) + (perOneAutoScience27 * Prod_27_Level) + (perOneAutoScience31 * Prod_31_Level) +
                        (perOneAutoScience34 * Prod_34_Level) + (perOneAutoScience37 * Prod_37_Level)) * (GameManager.Engine2Bonus)) + (perOneAutoScience40 * Prod_40_Level) + (perOneAutoScience43 * Prod_43_Level) + (perOneAutoScience47 * Prod_47_Level) +
